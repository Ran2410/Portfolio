...
const projects = [
  {
    id: 1,
    title: 'Sisfo Sarpras',
    description: 'School infrastructure management system with Laravel backend and Flutter mobile app for borrowing & returning items.',
  ...
  },
  {
    id: 2,
    title: 'Schedulingo',
    description: 'Modern task management web app with to-do lists, editing, and reminder features for daily productivity.',
  ...
  },
  {
    ...
    description: 'Full-stack RAG system with Express, PostgreSQL pgvector, and OpenRouter AI integration.',
  ...
  },
  {
    id: 4,
    title: 'KlikAja',
    description: 'E-commerce platform with Laravel & Livewire — seamless product exploration, cart, and checkout.',
  ...
  },
  {
    id: 5,
    title: 'StarMart',
    description: 'Food ordering mobile application built with Flutter — responsive interface and fast ordering experience.',
    tags: ['Flutter', 'Dart'],
    category: 'mobile',
  ...
  },
  {
    id: 6,
    title: 'Slapp',
    description: 'Real-time chat application built with Node.js and Socket.io for seamless communication.',
  ...
  return (
    <section id="projects" className="py-32 px-6 md:px-12 lg:px-20">
      <div className="max-w-6xl mx-auto">
        {/* Section header — clean, no // comment */}
            ...
            {filtered.map((project, i) => (
              <motion.a
                ...
                className={`group block bg-bg-surface rounded-xl border border-border-subtle
                           hover:border-border-hover transition-colors duration-300 overflow-hidden
              ...
              >
                ...
                <div className="p-5">
                  <div className="flex items-start justify-between gap-3">
                    ...
                    {/* Arrow — only on hover, subtle */}
                    <svg
                      className={`w-4 h-4 mt-1 text-fg-tertiary transition-all duration-300 flex-shrink-0 ${
                        hoveredId === project.id ? 'opacity-100 -translate-y-0.5 translate-x-0.5' : 'opacity-0'
                      }`}
                      viewBox="0 0 24 24"
                      fill="none"
                      stroke="currentColor"
        ...
        {filtered.length === 0 && (
          ...
          >
            <p className="font-mono text-sm text-fg-tertiary">No projects in this category</p>
          </motion.div>
        )}
